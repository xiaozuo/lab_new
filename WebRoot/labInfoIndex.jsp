...
<div id="main">
   <div style="margin-left:10px;padding-top:10px;">
    ...
    <div class="details_container">
        ...
        <b style=" font-family:'华文新魏'; font-size:24px;color:#f0f;"></b>
    	<div><b>实验室名称：</b>${lab_name}</div>
    	<div><b>负责人：</b>${lab_chief}</div>
    	<div><b>成立时间：</b>${lab_settime}</div>
    	<div><b>研究领域：</b><div  id="labInfoIndexReseachArea">${lab_researchArea}</div></div>
    	<div id="labInfoIndexDetailPosition">
    		<b>实验室详情：</b><div id="labInfoIndexDetail">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${lab_detail}</div>
        </div>
    </div>
</div>
</body>
